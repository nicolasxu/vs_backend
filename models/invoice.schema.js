...
var invoiceSchema = new Schema ({
	fromCompany: {
		companyId: ObjectId, // company id of sender company
		name: String, // sender company name
		userId: ObjectId, // user id who is sending this invoice
		userName: String
	},
	toCompany: {
		companyId: ObjectId, // company id of receiver company
		name: String  // receiver company name
	},
	templateId: String,
